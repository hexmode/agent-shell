...
| C-TAB or C-<tab>   | agent-shell-cycle-session-mode                   | Cycle through available session modes for the current `agent-shell' session. |
...
| C-c m              | agent-shell-set-session-mode                     | Set session mode (if any available).                                         |

...
|                 | agent-shell-prompt-compose-cancel                     | Cancel prompt composition.                                                   |
|                 | agent-shell-prompt-compose-edit-mode                  | Major mode for composing agent shell prompts.                                |
|                 | agent-shell-prompt-compose-interrupt                  | Interrupt active agent shell request.                                        |
|                 | agent-shell-prompt-compose-next-interaction           | Show next interaction (request / response).                                  |
|                 | agent-shell-prompt-compose-next-item                  | Go to next item.                                                             |
|                 | agent-shell-prompt-compose-previous-interaction       | Show previous interaction (request / response).                              |
|                 | agent-shell-prompt-compose-previous-item              | Go to previous item.                                                         |
|                 | agent-shell-prompt-compose-refresh                    | Refresh compose buffer content with current item from shell.                 |
|                 | agent-shell-prompt-compose-reply                      | Reply as a follow-up and compose another query.                              |
|                 | agent-shell-prompt-compose-send                       | Send the composed prompt to the agent shell.                                 |
|                 | agent-shell-prompt-compose-send-and-kill              | Send the composed prompt to the agent shell and kill compose buffer.         |
|                 | agent-shell-prompt-compose-send-and-wait-for-response | Send the composed prompt to the agent shell.                                 |
|                 | agent-shell-prompt-compose-view-last                  | Display the last request/response interaction.                               |
|                 | agent-shell-prompt-compose-view-mode                  | Major mode for viewing agent shell prompts (read-only).                      |
